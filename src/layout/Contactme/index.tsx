      ...
      <div className="support-section mt-[130px] mb-[110px] font-jakarta">
        <div className="container lg:px-[110px]">
          <div className='support-section-wrapper relative 2xl:mx-[232px]'>
            <div className='support-ellipse-yellow absolute top-0 -translate-y-32 translate-x-[100px] lg:-translate-y-44 2xl:translate-x-[550px] w-3/4 -z-40'>
              <img src={EllipseYellow} />
            </div>
            <div className='support-ellipse-blue absolute top-0 right-0 left-0 translate-y-60 -translate-x-20 xl:translate-y-20 xl:-translate-x-44 px-8 -z-40'>
              <img src={EllipseBlue} />
            </div>
            <div className='support-header backdrop-blur-lg border border-[#E1DFDF] rounded-2xl px-3 lg:px-[83px] py-[27px] z-20'>
              ...
              <div className="support-email relative mt-2">
                <form className='relative support-input flex justify-center items-center'>
                  <input className='bg-very-dark-blue text-white w-full relative rounded-full pl-5 pr-[105px] py-2 outline-none caret-white placeholder:text-white/50' required placeholder="youexample@gmail.com" />
