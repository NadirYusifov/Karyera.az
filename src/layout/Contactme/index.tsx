      ...
      <div className="support-section mt-[130px] mb-[110px] font-jakarta">
        <div className="container lg:px-[110px]">
          <div className='support-section-wrapper relative 2xl:mx-[232px]'>
            <div className='support-ellipse-yellow absolute top-0 -translate-y-32 translate-x-32 lg:-translate-y-14 lg:translate-x-80 flex flex-col justify-center items-center w-3/4 lg:w-full h-full -z-40'>
              <img src={EllipseYellow} />
            </div>
            <div className='support-ellipse-blue absolute top-0 translate-y-32 -translate-x-20 lg:translate-y-28 lg:-translate-x-44 flex flex-col justify-center items-center h-full rounded-2xl py-10 bg-transparent px-8 -z-40'>
              <img src={EllipseBlue} />
            </div>
            <div className='support-header backdrop-blur-lg border border-[#E1DFDF] rounded-2xl px-3 lg:px-[83px] py-[27px] z-20'>
              ...
              <div className="support-email relative mt-2">
                <form className='relative support-input flex justify-center items-center'>
                  <input className='bg-very-dark-desaturated-cyan text-white w-full relative rounded-full pl-5 pr-[105px] py-2 outline-none caret-white placeholder:text-white/50' required placeholder="youexample@gmail.com" />
